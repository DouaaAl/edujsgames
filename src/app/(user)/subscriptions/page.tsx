    ...
    <main className={styles.main}>
      ...
      <div className={styles.cards}>
        <div className={styles.midCard + ' ' + styles.card}>
          <div>
            <h1 className={styles.price}> <span className={styles.num}>$6.99/</span> <br />Month</h1>
            <span className={styles.date}>1 Month</span>
          </div>
            <ul>
            <li><h4>Acess to All subscription<br />Games</h4></li>              
            <li><h4>Acess to Time constraints</h4></li>
            <li><h4>Acess to Adding Study <br />Materials</h4></li>
            </ul>
            <a href={
        ...
        <div className={styles.mainCard + ' ' + styles.card}>
          <div>
            <h1 className={styles.price}><span className={styles.num}>$4.99/</span><br />Month</h1>
        ...
        <div className={styles.smCard+ ' ' + styles.card}>
          <div>
            <h1 className={styles.price}><span className={styles.num}>$2.99/</span><br />Month</h1>
            <span className={styles.date}>12 Months</span>
          </div>
            <ul>
            <li><h4>Acess to All subscription<br />Games</h4></li> 
